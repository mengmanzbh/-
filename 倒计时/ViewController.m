...
- (void)countDownBtnAction:(UIButton *)button{
    ...
    [button startWithTime:120 title:@"点击重新获取" countDownTitle:@"s" mainColor:[UIColor colorWithRed:84 / 255.0 green:180 / 255.0 blue:98 / 255.0 alpha:1.0f] countColor:[UIColor colorWithRed:84 / 255.0 green:180 / 255.0 blue:98 / 255.0 alpha:1.0f]];
